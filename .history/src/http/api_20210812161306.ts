...
export default {
  ...
  // 添加商品分类
  addgoos({ cat_pid, cat_name, cat_level }: { cat_pid: number, cat_name: string, cat_level: number }) {
  ...
  // 添加商品
  addgoods({ goods_name, goods_cat, goods_price, goods_number, goods_weight, goods_introduce, pics, attrs }: { goods_name: string, goods_cat: string, goods_price: number, goods_number: number, goods_weight: number, goods_introduce: string, pics: any, attrs: any }) {
