<template>
  <div>
    <el-card class="box-card">
      ...
      <el-dialog title="分配权限" v-model="flag" width="50%">
        <el-tree :data="list" show-checkbox node-key="id" :props="defaultProps">
        </el-tree>
        <template #footer>
          <span class="dialog-footer">
