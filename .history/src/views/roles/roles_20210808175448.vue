                  ...
                  <div class="flex-a boxtag">
                    <div class="tag">
                      <el-tag
                        ...
                        @close="close(props.row.id, item.id, Number(index))"
                      >
                        {{ item.authName }}
                      </el-tag>
                      ...
                      >
                        <div class="twotag">
                          <el-tag
                            ...
                            type="success"
                            @close="
                              close(props.row.id, item1.id, Number(index))
                            "
                          >
                            {{ item1.authName }}
                          </el-tag>
                        ...
                        <div class="flex">
                          ...
                          >
                            <el-tag
                              ...
                              closable
                              @close="
                                close(props.row.id, item2.id, Number(index))
                              "
                            >
...
export default defineComponent({
  setup() {
    ...
    let id = ref<number>(0); //大类角色roleId id
    const user = ref<Obj1>({
      //添加用户
      roleName: "",
      roleDesc: "",
    ...
    // 操作编辑
    let handle = (item: any, num: number) => {
      id.value = item.id;
    ...
    // 关闭标签
    let close = (roleId: number, rightId: number, index: number) => {
      console.log(roleId, rightId, index);
      api
