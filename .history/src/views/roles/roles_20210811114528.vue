                      ...
                      >
                        <div class="twotag">
                          <el-tag
                            ...
                            :disable-transitions="false"
                            type="success"
                            @close="close(props.row, item1.id)"
                          >
                            {{ item1.authName }}
                          </el-tag>
                          <i class="el-icon-caret-right"></i>
                        ...
                        <div class="flex">
                          ...
                          >
                            <el-tag
                              type="warning"
                              closable
                              @close="close(props.row, item2.id)"
                            >
...
export default defineComponent({
  setup() {
    ...
    // 关闭标签
    const close = (row: any, rightId: number) => {
      api
        .deloneroles({ roleId: row.id, rightId: rightId })
        .then((res) => {
