    ...
    <div class="flex-sb mat20">
      <div>
        <el-tabs tab-position="left" @tab-click="click" v-model="activeName">
          ...
          >
          <el-tab-pane label="商品参数" name="1" :disabled="!(active >= 0)">
            <div class="nexttwo">
          ...
          <el-tab-pane label="商品属性" name="2" :disabled="!(active >= 1)">
            <div class="nexttwo">
              <div v-for="(item, index) in only" :key="index">
                <div class="guige">
                  {{ item.attr_name }}
          ...
          <el-tab-pane label="商品图片" name="3" :disabled="!(active >= 2)">
            <el-upload
              class="upload-demo"
              drag
              action="/api/upload"
          ...
          <el-tab-pane label="商品内容" name="4" :disabled="!(active >= 3)"
            ><div id="div1"></div
          ></el-tab-pane>
        </el-tabs>
      </div>
