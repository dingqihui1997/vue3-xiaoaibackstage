      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            icon="el-icon-edit"
            size="mini"
            @click="handleEdit(scope.row, 1, scope.row.index)"
            >编辑</el-button
          >
          <el-button
            type="danger"
            icon="el-icon-delete"
            size="mini"
            @click="handleEdit(scope.row, 0, scope.row.index)"
            >删除</el-button
          >
        </template>
      </el-table-column>
...
export default defineComponent({
  setup() {
    ...
    // 编辑操作
    let handleEdit = (item: any, index: number, index1: number) => {
      console.log(index1);
      num.value = 0;
